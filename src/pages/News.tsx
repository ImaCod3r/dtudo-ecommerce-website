    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
            <div className="bg-blue-50 p-6 rounded-full mb-6 animate-pulse">
                <Sparkles className="w-16 h-16 text-[#028DFE]" />
            </div>
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Novidades</h1>
            <p className="text-lg text-gray-600 mb-8 max-w-md">
                Estamos a preparar as últimas novidades para si. Esta página estará disponível brevemente.
            </p>
            <button
                onClick={() => navigate('/')}
